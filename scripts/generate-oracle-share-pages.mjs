...
const locales = {
  uk: {
    ...
    heroText: "Невеликий текст до цих днів і перехід на сторінку зустрічі у Варшаві 9–10 травня.",
  ...
  ru: {
    ...
    heroText: "Небольшой текст к этим дням и переход на страницу встречи в Варшаве 9–10 мая.",
