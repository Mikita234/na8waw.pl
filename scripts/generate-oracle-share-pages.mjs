...
const locales = {
  uk: {
    ...
    heroText: "Передбачення від Вищої Сили і швидкий перехід на ювілей групи «МАЇВКА» у Варшаві 9–10 травня.",
    buttonText: "Відкрити передбачення і подію",
  ...
  ru: {
    ...
    heroText: "Предсказание от Высшей силы и быстрый переход на юбилей группы «МАЕВКА» в Варшаве 9–10 мая.",
    buttonText: "Открыть предсказание и мероприятие",
