...
$stmt = $pdo->query("SELECT id, author, message, image_path, approved_at, created_at FROM wishes WHERE status = 'approved' ORDER BY COALESCE(approved_at, created_at) DESC LIMIT 60");
$items = array_map(
